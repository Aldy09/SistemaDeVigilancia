...
use super::vendor::{HttpOptions, Map, MapMemory, Place, Places, Position, Style, Tiles, TilesManager};
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                while let Ok(camera) = self.camera_rx.try_recv() {
                    ...
                    let (latitude, longitude) = (camera.get_latitude() as f64, camera.get_longitude() as f64);
