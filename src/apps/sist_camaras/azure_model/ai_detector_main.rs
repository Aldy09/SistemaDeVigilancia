...
// //use crate::apps::{incident_data::incident::Incident, sist_camaras::shareable_cameras_type::ShCamerasType};
// //use crate::apps::sist_camaras::azure_model::automatic_incident_detector::AutomaticIncidentDetector;
// //use crate::apps::sist_camaras::manage_stored_cameras::create_cameras;
...
// /*use rustx::{
//     apps::{
//         {incident_data::incident::Incident, sist_camaras::shareable_cameras_type::ShCamerasType},
//         sist_camaras::azure_model::automatic_incident_detector::AutomaticIncidentDetector,
//         sist_camaras::manage_stored_cameras::create_cameras
