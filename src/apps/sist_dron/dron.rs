...
use super::{
    battery_manager::BatteryManager, data::Data, dron_current_info::DronCurrentInfo, sist_dron_properties::SistDronProperties
};
...
impl Dron {
    ...
    fn fly_to(
        ...
        self.data.set_flying_info_values(dir, self.dron_properties.get_speed(), false)?;
